> **Legacy v1 Documentation (frozen)**
> This is the archived documentation for x402-core v1 (exact scheme, EVM).
> For migration guidance, see [MIGRATION.md](../../MIGRATION.md).
> For v2 documentation, see [docs/v2/README.md](../v2/README.md).
...
```js
// Use the legacy import path for v1 functionality
...
> * `paymentRequirementsPayload` -> from Server
